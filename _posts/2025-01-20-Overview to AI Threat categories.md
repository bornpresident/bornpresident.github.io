...
> Will I be categorizing the concept into types of threats, and which aspect of the CIA (Confidentiality, Integrity, and Authentication) triad is being impacted by these threats?  
> *(Hint: If it involves backdoors, integrity is probably waving goodbye)*
{: .prompt-info }
